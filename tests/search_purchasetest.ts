...
describe('Add item to cart using popular section on the homepage', () => {
  ...
  it('Enter item you want to find in the search bar', async () => {
    await driver.wait(browser.waitUntilElementIsVisible(homepage.searchbar,4000));
    await driver.wait (browser.enterText(homepage.searchbar, "blouse"));
    await driver.wait(browser.enter(homepage.searchbar));
    })
  it('Click on the item offered', async () => {
